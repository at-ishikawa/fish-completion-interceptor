...
set -q FCI_PLUGIN_GH_FZF_FZF_OPTION; or set FCI_PLUGIN_GH_FZF_FZF_OPTION --inline-info --multi --layout reverse --preview-window down:70% --bind $__FCI_PLUGIN_GH_FZF_FZF_KEY_BINDINGS
