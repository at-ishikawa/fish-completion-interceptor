function test_fci_plugin_kubectl_fzf
    ...
    set -l mock_kubectl_results \
        ...
        "NAME READY\npod1 1/1\npod2 1/1" \
        "NAME READY\npod1 1/1\npod2 1/1"
    set -l expected_kubectl_commands \
    ...
    for i in (seq 1 (count $test_cases))
        ...
        set mock_kubectl_result $mock_kubectl_results[$i]
        function mock_kubectl \
            --inherit-variable expected_kubectl_command \
            --inherit-variable mock_kubectl_result
